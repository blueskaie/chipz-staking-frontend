export const MASTERCHEF_ADDRESS = '0xa865D8f12B57DFb527D19c460Ca7C5BC3d37b43d';
export const CHIPZ_ADDRESS = '0x679Dea061909F8836e8D0758043644330D0bd311';
export const CHIPZ_BNB_ADDRESS = '0xe05A281F2DbAcB5D891F1c0eA1BE0b99578a518C';

export const MASTERCHEF_ABI = [
    {
        inputs: [
            { internalType: 'contract MainToken', name: '_chipz', type: 'address' },
    ...
    },
    {
        inputs: [],
        name: 'chipz',
        outputs: [{ internalType: 'contract MainToken', name: '', type: 'address' }],
        stateMutability: 'view',
        type: 'function'
    },
    {
